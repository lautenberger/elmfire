...
SIMULATION_TSTOP=7000.0 # Simulation stop time (seconds)

NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=12.0  # Wind speed, mph
FLOAT_RASTER[2]=wd   ; FLOAT_VAL[2]=180.0 # Wind direction, deg
FLOAT_RASTER[3]=m1   ; FLOAT_VAL[3]=4.0   # 1-hr   dead moisture content, %
FLOAT_RASTER[4]=m10  ; FLOAT_VAL[4]=4.0   # 10-hr  dead moisture content, %
FLOAT_RASTER[5]=m100 ; FLOAT_VAL[5]=4.0   # 100-hr dead moisture content, %
...
INT_RASTER[5]=cc      ; INT_VAL[5]=60  # Canopy cover (percent)
INT_RASTER[6]=ch      ; INT_VAL[6]=375 # Canopy height (10*meters)
INT_RASTER[7]=cbh     ; INT_VAL[7]=0.1 # Canopy base height (10*meters)
...
ELMFIRE_VER=${ELMFIRE_VER:-2023.1001}
