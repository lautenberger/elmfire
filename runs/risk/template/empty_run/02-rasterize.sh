...
CLOUDFIRE_VER=${CLOUDFIRE_VER:-2023.0427}
...
function create_inputs {
   ...
   cat $H.csv | csvcut -c 3,4,7  > surface_fire_area_$H.csv
#   cat $H.csv | csvcut -c 3,4,8  > crown_fire_area_$H.csv
   cat $H.csv | csvcut -c 3,4,9  > fire_volume_$H.csv
   cat $H.csv | csvcut -c 3,4,10 > affected_population_$H.csv
