...
FIRE_INFO="$FIRENAME,$IGNITION_TIME,$IGNITION_LON,$IGNITION_LAT,$INITIALIZATION_TYPE,$ADD_TO_ACTIVE_FIRES,$RUN_HOURS,$IGNITION_RADIUS,$NUM_ENSEMBLE_MEMBERS,$ACTIVE_FIRE_TIMESTAMP,$ALREADY_BURNED_TIMESTAMP,$FUEL_SOURCE,$FUEL_VERSION,$RUN_TEMPLATE"
