...
REAL :: T_1MW, T_EARLY, T_FULLDEV, T_DECAY, FUEL_LOAD, HRRPUA_PEAK, FTP_CRIT, ABSORPTIVITY, &
        HEIGHT, NONBURNABLE_FRAC, P_IGNITION
INTEGER :: INUM, IOS
...
IOS = 0
DO WHILE (IOS .EQ. 0)
   READ(LUINPUT,*,IOSTAT=IOS) INUM,SHORTNAME,T_1MW,T_EARLY,T_FULLDEV,T_DECAY,FUEL_LOAD,HRRPUA_PEAK,FTP_CRIT,ABSORPTIVITY,HEIGHT,NONBURNABLE_FRAC,P_IGNITION
