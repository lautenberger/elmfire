...
REAL :: T_1MW, T_EARLY, T_FULLDEV, T_DECAY, FUEL_LOAD, HRRPUA_PEAK, FTP_CRIT, ABSORPTIVITY, &
        HEIGHT, NONBURNABLE_FRAC, P_IGNITION, HARDENING_FACTCOR, TAU_IGN
INTEGER :: INUM, IOS
...
BUILDING_FUEL_MODEL_TABLE(:)%HARDENING_FACTCOR=GLOBAL_HARDENING_FACTCOR
...
IOS = 0
DO WHILE (IOS .EQ. 0)
   READ(LUINPUT,*,IOSTAT=IOS) INUM,SHORTNAME,T_1MW,T_EARLY,T_FULLDEV,T_DECAY,FUEL_LOAD,HRRPUA_PEAK,FTP_CRIT,ABSORPTIVITY,HEIGHT,NONBURNABLE_FRAC,P_IGNITION, HARDENING_FACTCOR, TAU_IGN
   IF (IOS .EQ. 0 .AND. INUM .GE. 0 .AND. INUM .LE. NUM_BUILDING_FUEL_MODELS) THEN
      ...
      BUILDING_FUEL_MODEL_TABLE(INUM)%HARDENING_FACTCOR= HARDENING_FACTCOR
