...
! MODE=2 uses a fixed threshold on the raw mask; preserve ignition weighting in other modes.
IF (MODE .NE. 2 .AND. USE_IGNITION_MASK .AND. ADD_TO_IGNITION_MASK .GT. 0.) THEN
