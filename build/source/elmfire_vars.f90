...
INTEGER :: BAND_ONE_HOUR_OF_YEAR, CURRENT_YEAR, HOUR_OF_YEAR, UTC_OFFSET_HOURS
...
INTEGER(KIND=MPI_ADDRESS_KIND) :: ANALYSIS_SINGLEBAND_SIZE_REAL, ANALYSIS_SINGLEBAND_SIZE_INT, &
                                  ANALYSIS_SINGLEBAND_SIZE_L1, CALIBRATION_SIZE, WX_SIZE, STATS_SIZE, TIMINGS_SIZE
TYPE(C_PTR) :: ASP_PTR, CBH_PTR, CBD_PTR, CC_PTR, CH_PTR, DEM_PTR, FBFM_PTR, SLP_PTR, ADJ_PTR, PHI0_PTR, &
               POPULATION_DENSITY_PTR, REAL_ESTATE_VALUE_PTR, LAND_VALUE_PTR, CALIBRATION_TARGET_PTR, WAF_PTR, &
               OMCOSSLPRAD_PTR, WS_PTR, WD_PTR, M1_PTR, M10_PTR, M100_PTR, MLH_PTR, MLW_PTR, MFOL_PTR, ERC_PTR, &
               IGNFAC_PTR, STATS_X_PTR, STATS_Y_PTR, STATS_PROB_PTR, STATS_SURFACE_FIRE_AREA_PTR, &
               ...
               STATS_WALL_CLOCK_TIME_PTR, ISNONBURNABLE_PTR, TIMINGS_PTR, IGN_MASK_PTR, SDI_PTR, HAMADA_A_PTR, &
               HAMADA_D_PTR, HAMADA_FB_PTR, PYROMES_PTR, STATS_FINAL_CONTAINMENT_FRAC_PTR, STATS_PM2P5_RELEASE_PTR, &
               STATS_HRR_PEAK_PTR
...
TYPE(MPI_WIN) :: WIN_ASP,WIN_CBH,WIN_CBD,WIN_CC,WIN_CH,WIN_DEM,WIN_FBFM,WIN_SLP,WIN_ADJ,WIN_PHI0,WIN_POPULATION_DENSITY, &
                 ...
                 WIN_HAMADA_D, WIN_HAMADA_FB, WIN_PYROMES, WIN_STATS_FINAL_CONTAINMENT_FRAC, WIN_STATS_PM2P5_RELEASE, &
                 WIN_STATS_HRR_PEAK
