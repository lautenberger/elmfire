...
LOGICAL :: ACCUMULATE_EMBER_FLUX, CONVERT_TO_GEOTIFF, DUMP_AFFECTED_LAND_VALUE, DUMP_AFFECTED_POPULATION, &
           ...
           DUMP_WS20, ROTATE_ASP, ROTATE_WD, USE_EMBER_COUNT_BINS, USE_FLAME_LENGTH_BINS
...
REAL :: CRITICAL_SPOTTING_FIRELINE_INTENSITY(0:303), CROWN_FIRE_SPOTTING_PERCENT, CROWN_FIRE_SPOTTING_PERCENT_MAX, &
        ...
        SPOT_WS_EXP_LO, EMBER_GR, TAU_EMISSION, P_EPS

LOGICAL :: ENABLE_SPOTTING, ENABLE_SURFACE_FIRE_SPOTTING, STOCHASTIC_SPOTTING, USE_UMD_SPOTTING_MODEL
