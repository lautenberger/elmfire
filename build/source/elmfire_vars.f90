...
INTEGER, PARAMETER :: LUINPUT = 100, LUOUTPUT = 200, LUSMOKE=800, LUFIT=900

! Namelist group inputs, organized by namelist group:

! &CALIBRATION
INTEGER :: DURATION_MAX_DAYS, NUM_CALIBRATION_TIMES, NUM_MONTE_CARLO_VARIABLES, NUM_PARAMETERS_MISC, &
           NUM_PARAMETERS_RASTERS, NUM_PARAMETERS_SPOTTING
REAL :: FIT_BB, FIT_BMNT, FIT_BTNM
REAL, DIMENSION(1:100) :: CALIBRATION_TIMES
...
CHARACTER(400) :: ADJUSTMENT_FACTORS_FILENAME, CALIBRATION_CONSTANTS_FILENAME, CALIBRATION_TARGET_FILENAME, &
...
! &INPUTS
! Filenames:
CHARACTER(400) ::  ADJ_FILENAME,  ASP_FILENAME,  CBD_FILENAME, CBH_FILENAME, CC_FILENAME, &
                   CH_FILENAME, DEM_FILENAME, FBFM_FILENAME, HAMADA_A_FILENAME, HAMADA_D_FILENAME, &
                   HAMADA_FB_FILENAME, IGNITION_MASK_FILENAME, IGNITIONS_CSV_FILENAME, LAND_VALUE_FILENAME, &
                   PHI_FILENAME, &
                   ...
                   PYROMES_FILENAME, RH_FILENAME, SDI_FILENAME, TMP_FILENAME, WD_FILENAME, WS_FILENAME
...
REAL :: DT_METEOROLOGY, FOLIAR_MOISTURE_CONTENT, GRID_DECLINATION, LH_MOISTURE_CONTENT, &
        LW_MOISTURE_CONTENT, FOOTPRINT_PERCENTAGE

LOGICAL :: CALCULATE_BURN_PROBABILITY, CALCULATE_FLAME_LENGTH_STATS, CALCULATE_TIMES_BURNED, CBD_TIMES_100,  &
...
LOGICAL :: ACCUMULATE_EMBER_FLUX, CONVERT_TO_GEOTIFF, DUMP_AFFECTED_LAND_VALUE, DUMP_AFFECTED_POPULATION, &
           DUMP_AFFECTED_REAL_ESTATE_VALUE, DUMP_BINARY_OUTPUTS, DUMP_CROWN_FIRE, DUMP_CASES_TO_RUN_UP_FRONT, &
           DUMP_EMBER_FLUX, DUMP_CROWN_FIRE_AREA, DUMP_FIRE_SIZE_STATS, DUMP_FIRE_VOLUME, &
           DUMP_FLAME_LENGTH, DUMP_FLIN, DUMP_HOURLY_RASTERS, DUMP_HOURLY_RASTERS_ASAP, DUMP_HPUA, &
           DUMP_INTERMEDIATE_FIRE_SIZE_STATS, DUMP_INTERMEDIATE_TIMINGS, DUMP_ISOCHRONE_SHAPEFILES, DUMP_PHI, &
           DUMP_PROGRESS_MESSAGES, DUMP_REACTION_INTENSITY, DUMP_REAL_ESTATE_VALUE, &
...
INTEGER :: NUM_VIRTUAL_STATIONS, NUM_EMBER_COUNT_BINS, NUM_FLAME_LENGTH_BINS
REAL :: DTDUMP, VIRTUAL_STATION_X(100), VIRTUAL_STATION_Y(100), FLAME_LENGTH_BIN_LO(100), FLAME_LENGTH_BIN_HI(100)
INTEGER*2 :: EMBER_COUNT_BIN_LO(100), EMBER_COUNT_BIN_HI(100)

! &SIMULATOR
INTEGER :: BANDTHICKNESS
LOGICAL :: ALLOW_MULTIPLE_IGNITIONS_AT_A_PIXEL, ALLOW_NONBURNABLE_PIXEL_IGNITION, &
           ...
           WIND_FLUCTUATIONS, USE_CONSTANT_HAMADA_PARAMETERS, USE_HAMADA, USE_PYROMES, MULTIPLE_HOSTS

REAL :: ANALYSIS_CELLSIZE, ANALYSIS_XLLCORNER, ANALYSIS_YLLCORNER, CRITICAL_CANOPY_COVER, &
        CROWN_FIRE_ADJ, CROWN_FIRE_SPREAD_RATE_LIMIT, DT_WIND_FLUCTUATIONS, EDGEBUFFER, HAMADA_A_CONSTANT, &
        HAMADA_D_CONSTANT, HAMADA_FB_CONSTANT, MAX_LOW, MAX_RUNTIME,  PERCENT_OF_PIXELS_TO_IGNITE, &
...
REAL :: CRITICAL_SPOTTING_FIRELINE_INTENSITY(0:303), CROWN_FIRE_SPOTTING_PERCENT, CROWN_FIRE_SPOTTING_PERCENT_MAX, &
        ...
        SPOT_WS_EXP_LO, EMBER_GR, TAU_EMISSION, P_EPS, N_PHYSIC_EMBER_PER_NUMER

LOGICAL :: ENABLE_SPOTTING, ENABLE_SURFACE_FIRE_SPOTTING, STOCHASTIC_SPOTTING, &
           USE_UMD_SPOTTING_MODEL, USE_PHYSICAL_SPOTTING_DURATION, USE_PHYSICAL_EMBER_NUMBER,&
           USE_SPOTTING_LOOKUP_TABLE
...
! &SMOKE
REAL :: DT_SMOKE_OUTPUTS, SMOKE_HOC, SMOKE_YIELD, SMOKE_YIELD_BY_FUEL(0:303), SMOKE_OUTPUTS_DUMP_PERCENT
...
! &TIME_CONTROL
REAL :: BURN_PERIOD_CENTER_FRAC,BURN_PERIOD_LENGTH, DT_INTERPOLATE_M1, DT_INTERPOLATE_M10, DT_INTERPOLATE_M100, &
        DT_INTERPOLATE_MLH, DT_INTERPOLATE_MLW, DT_INTERPOLATE_FMC, DT_INTERPOLATE_WIND, FORECAST_START_HOUR, &
        LATITUDE, LONGITUDE, OVERNIGHT_ADJUSTMENT_FACTOR, SIMULATION_DT, SIMULATION_DTMAX, &
        SIMULATION_TSTART, SIMULATION_TSTOP, SUNRISE_HOUR, SUNSET_HOUR, TARGET_CFL
INTEGER :: CURRENT_YEAR, HOUR_OF_YEAR, UTC_OFFSET_HOURS
...
INTEGER(KIND=MPI_ADDRESS_KIND) :: ANALYSIS_SINGLEBAND_SIZE_REAL, ANALYSIS_SINGLEBAND_SIZE_INT, ANALYSIS_SINGLEBAND_SIZE_L1, &
                                  CALIBRATION_SIZE, WX_SIZE, STATS_SIZE, TIMINGS_SIZE
TYPE(C_PTR) :: ASP_PTR, CBH_PTR, CBD_PTR, CC_PTR, CH_PTR, DEM_PTR, FBFM_PTR, SLP_PTR, ADJ_PTR, PHI0_PTR, POPULATION_DENSITY_PTR, &
               REAL_ESTATE_VALUE_PTR, LAND_VALUE_PTR, CALIBRATION_TARGET_PTR, WAF_PTR, OMCOSSLPRAD_PTR, WS_PTR, WD_PTR, M1_PTR, &
               M10_PTR, M100_PTR, MLH_PTR, MLW_PTR, MFOL_PTR, ERC_PTR, IGNFAC_PTR, STATS_X_PTR, STATS_Y_PTR, STATS_PROB_PTR, &
               STATS_SURFACE_FIRE_AREA_PTR, STATS_CROWN_FIRE_AREA_PTR, STATS_FIRE_VOLUME_PTR, STATS_AFFECTED_POPULATION_PTR, &
               STATS_AFFECTED_REAL_ESTATE_VALUE_PTR, STATS_AFFECTED_LAND_VALUE_PTR, STATS_NEMBERS_PTR, STATS_IWX_BAND_START_PTR, &
               STATS_IWX_SERIAL_BAND_PTR, STATS_SIMULATION_TSTOP_HOURS_PTR, STATS_WALL_CLOCK_TIME_PTR, ISNONBURNABLE_PTR, &
               TIMINGS_PTR, IGN_MASK_PTR, SDI_PTR, HAMADA_A_PTR, HAMADA_D_PTR, HAMADA_FB_PTR, PYROMES_PTR, &
               STATS_FINAL_CONTAINMENT_FRAC_PTR

TYPE(MPI_WIN) :: WIN_ASP,WIN_CBH,WIN_CBD,WIN_CC,WIN_CH,WIN_DEM,WIN_FBFM,WIN_SLP,WIN_ADJ,WIN_PHI0,WIN_POPULATION_DENSITY, &
                 WIN_REAL_ESTATE_VALUE,WIN_LAND_VALUE,WIN_CALIBRATION_TARGET,WIN_WAF,WIN_OMCOSSLPRAD, WIN_WS, WIN_WD, &
                 WIN_M1, WIN_M10, WIN_M100, WIN_MLH, WIN_MLW, WIN_MFOL, WIN_ERC, WIN_IGNFAC, WIN_STATS_X, WIN_STATS_Y, &
                 WIN_STATS_PROB, WIN_STATS_SURFACE_FIRE_AREA, WIN_STATS_CROWN_FIRE_AREA, WIN_STATS_FIRE_VOLUME, &
                 ...
                 WIN_STATS_WALL_CLOCK_TIME, WIN_ISNONBURNABLE, WIN_TIMINGS, WIN_IGN_MASK, WIN_SDI, WIN_HAMADA_A, &
                 WIN_HAMADA_D, WIN_HAMADA_FB, WIN_PYROMES, WIN_STATS_FINAL_CONTAINMENT_FRAC

INTEGER :: ARRAYSHAPE_ANALYSIS_SINGLEBAND(1:3), ARRAYSHAPE_CALIBRATION(1:3), ARRAYSHAPE_WX(1:3), ARRAYSHAPE_STATS(1), &
...
! Profiling:
INTEGER :: CLOCK_COUNT_MAX, CLOCK_COUNT_RATE, IT_START, IT_STOP
...
REAL, ALLOCATABLE, DIMENSION (:,:) :: TIME_OF_ARRIVAL, TIME_TO_IGNITE ! TIME_TO_IGNITE is added to memory the landing time of embers

! 1D geospatial arrays
INTEGER*2, ALLOCATABLE, DIMENSION(:) :: EVERTAGGED_IX, EVERTAGGED_IY

REAL, POINTER, DIMENSION(:) :: STATS_X, STATS_Y, STATS_PROB, STATS_SURFACE_FIRE_AREA, STATS_CROWN_FIRE_AREA, &
                               ...
                               STATS_WALL_CLOCK_TIME, STATS_FINAL_CONTAINMENT_FRAC
...
! Calibration / optimization / fitness
...
INTEGER, ALLOCATABLE, DIMENSION(:) :: CSV_IBANDARR, CSV_ICASEARR, NUM_CASES_PER_STARTING_WX_BAND, NUM_CASES_COMPLETE_PER_STARTING_WX_BAND, &
                                      IWX_BAND_START_TEMP, IWX_SERIAL_BAND_TEMP 

REAL :: DIURNAL_ADJUSTMENT_FACTOR = 1.0
REAL, POINTER, DIMENSION(:,:,:) :: WSP, WDP, M1P, M10P, M100P, MLHP, MLWP, MFOLP, ERCP, IGNFACP
REAL, ALLOCATABLE, DIMENSION(:) :: CSV_XARR, CSV_YARR
...
TYPE(RASTER_TYPE), TARGET :: ADJ, ANALYSIS_SURFACE_FIRE, ANALYSIS_TIMES_BURNED, ASP, BURN_PROBABILITY, &
                             CALIBRATION_TARGET, CBD, CBH, CC, CH, DEM, FLAME_LENGTH_SUM, EMBER_BIN_COUNT, &
                             FLAME_LENGTH_BIN_COUNT, FLAME_LENGTH_MAX, FBFM, HAMADA_A, HAMADA_D, HAMADA_FB, &
                             IGN_MASK, LAND_VALUE, OMCOSSLPRAD, &
...
TYPE NODE
   ...
   REAL :: LOCAL_EMISSION_DURATION       = 0.
