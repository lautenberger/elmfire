...
REAL :: DTDUMP, FLAME_LENGTH_BIN_LO(100), FLAME_LENGTH_BIN_HI(100)
...
REAL, POINTER, DIMENSION(:) :: STATS_X, STATS_Y, STATS_ASTOP, STATS_SURFACE_FIRE_AREA, STATS_CROWN_FIRE_AREA, &
