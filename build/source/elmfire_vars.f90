...
INTEGER, PARAMETER :: LUINPUT = 100, LUOUTPUT = 200, LUSMOKE=800, LUFIT=9000, LUBAT=7000
...
INTEGER :: NUM_VIRTUAL_STATIONS, NUM_EMBER_COUNT_BINS, NUM_FLAME_LENGTH_BINS, NUM_TIME_AT_BURNED_ACRES
...
TYPE(C_PTR) :: ASP_PTR, CBH_PTR, CBD_PTR, CC_PTR, CH_PTR, DEM_PTR, FBFM_PTR, SLP_PTR, ADJ_PTR, PHI0_PTR, &
               ...
               IGNFAC_PTR, STATS_X_PTR, STATS_Y_PTR, STATS_ASTOP_PTR, STATS_PROB_PTR, STATS_SURFACE_FIRE_AREA_PTR, &
...
REAL, POINTER, DIMENSION(:) :: STATS_X, STATS_Y, STATS_ASTOP, STATS_PROB, STATS_SURFACE_FIRE_AREA, STATS_CROWN_FIRE_AREA, &
...
REAL, ALLOCATABLE, DIMENSION(:) :: CSV_XARR, CSV_YARR, CSV_ASTOP
