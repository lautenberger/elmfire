...
! Parsed once by READ_INPUTS; keep model-name strings out of cell/node loops.
LOGICAL :: SURFACE_MODEL_ROTHERMEL = .TRUE., SURFACE_MODEL_CFFDRS = .FALSE.
! Resident weather is valid only after conversion, rotation and host distribution.
LOGICAL :: WEATHER_CACHE_VALID = .FALSE.
...
!************************************************  &OUTPUTS ************************************************ 
! Initialize here as well for elmfire_post, which does not call READ_OUTPUTS.
CHARACTER(32) :: COMPRESSION_ALGO = 'DEFLATE'
INTEGER :: ZLEVEL = 9
LOGICAL :: ACCUMULATE_EMBER_FLUX, CONVERT_TO_GEOTIFF, DUMP_AFFECTED_LAND_VALUE, DUMP_AFFECTED_POPULATION, &
           ...
           DUMP_TIME_OF_ARRIVAL, DUMP_TIMES_CSV, DUMP_TIMINGS, DUMP_TRANSIENT_ACREAGE, DUMP_VELOCITY, DUMP_WD20, &
...
! Requested CRS: at most 4095 characters; use a CRS-file path for longer WKT.
CHARACTER(4096) :: A_SRS = ''
! Each rank owns this WKT file until orderly shutdown (unallocated before resolution).
CHARACTER(:), ALLOCATABLE :: ANALYSIS_SRS_FILE
...
CHARACTER(9) :: NULL_DEVICE = '/dev/null'
