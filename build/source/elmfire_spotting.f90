...
CHARACTER(3) :: THREE
CHARACTER(400) :: FNOUT
REAL :: R0, IGNPROB, WD1TO, WD2TO, WDTO, WS20, T, TSTOP, DT, X_HIGH, X_LOW, HIGH, LOW, X_MAX, P_IGNITION
...
CHARACTER(3) :: THREE
CHARACTER(400) :: FNOUT
REAL :: R0, WD1TO, WD2TO, WDTO, WS20, T, TSTOP, DT, X_MAX, NORM_FACTOR, P_LAND, DIST_LAST, F_WIND
REAL, DIMENSION(3) :: X, X0, UWIND, OFFSET
INTEGER :: IX, IY, IXLAST, IYLAST,ICOL, IROW, ICOUNT, K_MAX, IT_IGN, ITLO_METEOROLOGY, ITHI_METEOROLOGY
