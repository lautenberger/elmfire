...
DUMP_SPOTTING_OUTPUTS, DUMP_EMBER_FLUX_UMD, RUN_ID
...
DUMP_HPUA                         = .FALSE. 
DUMP_INTERMEDIATE_FIRE_SIZE_STATS = .FALSE. ! DEPRECATED - can be deleted
...
NAMELIST /WUI/ BLDG_AREA_CONSTANT, BLDG_NONBURNABLE_FRAC_CONSTANT, BLDG_SEPARATION_DIST_CONSTANT, &
               ...
               USE_BLDG_SPREAD_MODEL, USE_CONSTANT_BLDG_SPREAD_MODEL_PARAMS
...
P_EPS, USE_PHYSICAL_SPOTTING_DURATION, USE_PHYSICAL_EMBER_NUMBER, EMBER_SAMPLING_FACTOR, USE_EULERIAN_FRAMEWORK, &
USE_SUPERSEDED_SPOTTING, DT_DUMP_EMBER_FLUX
