...
NAMELIST /OUTPUTS/ &
ACCUMULATE_EMBER_FLUX, CALCULATE_TIMES_BURNED, CALCULATE_FLAME_LENGTH_STATS, &
...
FULL_BINARY_OUTPUTS, NUM_EMBER_COUNT_BINS, FLAME_LENGTH_BIN_LO, FLAME_LENGTH_BIN_HI, NUM_FLAME_LENGTH_BINS, &
OUTPUTS_DIRECTORY, USE_EMBER_COUNT_BINS, USE_FLAME_LENGTH_BINS, &
DUMP_SPOTTING_OUTPUTS, DUMP_EMBER_FLUX_UMD, RUN_ID, DUMP_TOTAL_DFC_RECEIVED, DUMP_TOTAL_RAD_RECEIVED, &
DUMP_HRR_TRANSIENT, TIME_AT_BURNED_ACRES
...
USE_SUPERSEDED_SPOTTING, DT_DUMP_EMBER_FLUX, NO_SURFACE_FIRE, USE_LEVEL_SET_DT_FOR_SPOTTING, BUILD_EMBER_FLUX_TABLE, USE_EMBER_IGNITION_MODEL
