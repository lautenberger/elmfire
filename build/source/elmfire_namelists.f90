...
DO WHILE (IOS .EQ. 0)
   READ (LUINPUT,*,IOSTAT=IOS) I8DUMMY, RDUMMY, RDUMMY
...
DO I = 1, NUM_TIMED_LOCATIONS
    READ (LUINPUT,*,IOSTAT=IOS) TIMED_LOCATIONS_TRACKER(I)%ID, TIMED_LOCATIONS_TRACKER(I)%X, TIMED_LOCATIONS_TRACKER(I)%Y
ENDDO
CLOSE(LUINPUT)
