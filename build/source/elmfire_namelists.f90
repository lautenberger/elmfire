...
WS_AT_10M, VRT_INSTEAD_OF_TIF, SDI_FILENAME, FOOTPRINT_PERCENTAGE
...
WEATHER_DIRECTORY              = ' '
WS_AT_10M                      = .FALSE.
FOOTPRINT_PERCENTAGE           = 1.0
! FOOTPRINT_PERCENTAGE_FILENAME  = ' '
...
OUTPUTS_DIRECTORY, USE_EMBER_COUNT_BINS, USE_FLAME_LENGTH_BINS, VIRTUAL_STATION_X, VIRTUAL_STATION_Y, DUMP_SPOTTING_OUTPUTS
...
P_EPS, USE_PHYSICAL_SPOTTING_DURATION, USE_PHYSICAL_EMBER_NUMBER, N_PHYSIC_EMBER_PER_NUMER, USE_SPOTTING_LOOKUP_TABLE
...
P_EPS                                     = 0.001 
USE_SPOTTING_LOOKUP_TABLE                 = .FALSE. ! This is not currently used
USE_PHYSICAL_SPOTTING_DURATION            = .FALSE.
USE_PHYSICAL_EMBER_NUMBER                 = .FALSE.
N_PHYSIC_EMBER_PER_NUMER                  = 50.0
