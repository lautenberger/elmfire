...
P_EPS, USE_PHYSICAL_SPOTTING_DURATION, USE_PHYSICAL_EMBER_NUMBER, N_PHYSIC_EMBER_PER_NUMER, USE_SPOTTIN_LOOKUP_TABLE
...
P_EPS                                     = 0.001 
USE_SPOTTIN_LOOKUP_TABLE                  = .FALSE. ! This is not currently used
