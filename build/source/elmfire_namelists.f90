...
DUMP_SPOTTING_OUTPUTS, DUMP_EMBER_FLUX_UMD, RUN_ID, DUMP_TOTAL_DFC_RECEIVED, DUMP_TOTAL_RAD_RECEIVED, &
DUMP_HRR_TRANSIENT
...
USE_SUPERSEDED_SPOTTING, DT_DUMP_EMBER_FLUX, NO_SURFACE_FIRE, USE_LEVEL_SET_DT_FOR_SPOTTING
...
USE_LEVEL_SET_DT_FOR_SPOTTING             = .FALSE.
