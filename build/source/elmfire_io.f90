...
CHARACTER(100), DIMENSION(0:200), SAVE :: FNS_SURFACE_FIRE, FNS_CROWN_FIRE, FNS_SPREAD_RATE, FNS_HPUA, FNS_FLIN, FNS_FLAME_LENGTH, &
                                          ...
                                          FNS_TOTAL_DFC_RECEIVED, FNS_TOTAL_RAD_RECEIVED, FNS_HRR_TRANSIENT

CHARACTER(20000) :: SHELLSTR

! .bil filenames:
CHARACTER(20000) :: FN_SURFACE_FIRE_BIL, FN_CROWN_FIRE_BIL, FN_SPREAD_RATE_BIL, FN_HPUA_BIL, FN_FLIN_BIL, &
                    ...
                    FN_TOTAL_DFC_RECEIVED_BIL, FN_TOTAL_RAD_RECEIVED_BIL, FN_HRR_TRANSIENT_BIL

! .hdr filenames:
CHARACTER(20000)   FN_SURFACE_FIRE_HDR, FN_CROWN_FIRE_HDR, FN_SPREAD_RATE_HDR, FN_HPUA_HDR, FN_FLIN_HDR, &
                   ...
                   FN_TOTAL_DFC_RECEIVED_HDR, FN_TOTAL_RAD_RECEIVED_HDR, FN_HRR_TRANSIENT_HDR

! .tif filenames:
CHARACTER(20000)   FN_SURFACE_FIRE_TIF,FN_CROWN_FIRE_TIF,FN_SPREAD_RATE_TIF, FN_HPUA_TIF, FN_FLIN_TIF, &
                   ...
                   FN_TOTAL_DFC_RECEIVED_TIF, FN_TOTAL_RAD_RECEIVED_TIF, FN_HRR_TRANSIENT_TIF
...
IF (DUMP_TOTAL_RAD_RECEIVED) THEN
   ...
   CALL WRITE_BIL_RASTER(RDUMPME,OUTPUTS_DIRECTORY,FN,CONVERT_TO_GEOTIFF,.TRUE.)
   FNS_TOTAL_RAD_RECEIVED(IDUMPCOUNT) = TRIM(FN)
ENDIF
...
IF (DUMP_HRR_TRANSIENT) THEN
   ...
   CALL WRITE_BIL_RASTER(RDUMPME,OUTPUTS_DIRECTORY,FN,CONVERT_TO_GEOTIFF,.TRUE.)
   FNS_HRR_TRANSIENT(IDUMPCOUNT) = TRIM(FN)
ENDIF
...
IF (IDUMPCOUNT .EQ. NDUMPS) THEN
   ...
   FN_TAGGED_BIL            = ' '
   FN_EMBER_FLUX_BIL        = ' '
   FN_TOTAL_DFC_RECEIVED_BIL= ' ' 
   FN_TOTAL_RAD_RECEIVED_BIL= ' ' 
   FN_HRR_TRANSIENT_BIL     = ' ' 
   ...
   FN_TAGGED_HDR            = ' '
   FN_EMBER_FLUX_HDR        = ' '
   FN_TOTAL_DFC_RECEIVED_HDR= ' ' 
   FN_TOTAL_RAD_RECEIVED_HDR= ' ' 
   FN_HRR_TRANSIENT_HDR     = ' ' 
   ...
   FN_TAGGED_TIF            = ' '
   FN_EMBER_FLUX_TIF        = ' '
   FN_TOTAL_DFC_RECEIVED_TIF= ' ' 
   FN_TOTAL_RAD_RECEIVED_TIF= ' ' 
   FN_HRR_TRANSIENT_TIF     = ' ' 
   ...
   DO IDUMPCOUNT = 1, NDUMPS
      ...
      IF (DUMP_TOTAL_DFC_RECEIVED    ) FN_TOTAL_DFC_RECEIVED_BIL = TRIM(FN_TOTAL_DFC_RECEIVED_BIL ) // " " // TRIM(DIR) // TRIM(FNS_TOTAL_DFC_RECEIVED(IDUMPCOUNT)) // ".bil"
      IF (DUMP_TOTAL_RAD_RECEIVED    ) FN_TOTAL_RAD_RECEIVED_BIL = TRIM(FN_TOTAL_RAD_RECEIVED_BIL ) // " " // TRIM(DIR) // TRIM(FNS_TOTAL_RAD_RECEIVED(IDUMPCOUNT)) // ".bil"
      IF (DUMP_HRR_TRANSIENT         ) FN_HRR_TRANSIENT_BIL      = TRIM(FN_HRR_TRANSIENT_BIL      ) // " " // TRIM(DIR) // TRIM(FNS_HRR_TRANSIENT     (IDUMPCOUNT)) // ".bil"
      ...
      IF (DUMP_TOTAL_DFC_RECEIVED    ) FN_TOTAL_DFC_RECEIVED_HDR = TRIM(FN_TOTAL_DFC_RECEIVED_HDR ) // " " // TRIM(DIR) // TRIM(FNS_TOTAL_DFC_RECEIVED(IDUMPCOUNT)) // ".hdr"
      IF (DUMP_TOTAL_RAD_RECEIVED    ) FN_TOTAL_RAD_RECEIVED_HDR = TRIM(FN_TOTAL_RAD_RECEIVED_HDR ) // " " // TRIM(DIR) // TRIM(FNS_TOTAL_RAD_RECEIVED(IDUMPCOUNT)) // ".hdr"
      IF (DUMP_HRR_TRANSIENT         ) FN_HRR_TRANSIENT_HDR      = TRIM(FN_HRR_TRANSIENT_HDR      ) // " " // TRIM(DIR) // TRIM(FNS_HRR_TRANSIENT     (IDUMPCOUNT)) // ".hdr"
      IF (.NOT. ACCUMULATE_EMBER_FLUX) THEN
      ...
      IF (DUMP_TOTAL_DFC_RECEIVED    ) FN_TOTAL_DFC_RECEIVED_TIF = TRIM(FN_TOTAL_DFC_RECEIVED_TIF ) // " " // TRIM(DIR) // TRIM(FNS_TOTAL_DFC_RECEIVED(IDUMPCOUNT)) // ".tif"
      IF (DUMP_TOTAL_RAD_RECEIVED    ) FN_TOTAL_RAD_RECEIVED_TIF = TRIM(FN_TOTAL_RAD_RECEIVED_TIF ) // " " // TRIM(DIR) // TRIM(FNS_TOTAL_RAD_RECEIVED(IDUMPCOUNT)) // ".tif"
      IF (DUMP_HRR_TRANSIENT         ) FN_HRR_TRANSIENT_TIF      = TRIM(FN_HRR_TRANSIENT_TIF      ) // " " // TRIM(DIR) // TRIM(FNS_HRR_TRANSIENT     (IDUMPCOUNT)) // ".tif"
      IF (.NOT. ACCUMULATE_EMBER_FLUX) THEN
...
IF (CONVERT_TO_GEOTIFF) THEN
      ...
      IF (DUMP_TOTAL_DFC_RECEIVED    .AND. CONVERT_TO_GEOTIFF) CALL MERGE_RASTERS(SEVEN, FN_TOTAL_DFC_RECEIVED_TIF , FN_TOTAL_DFC_RECEIVED_HDR , "total_dfc_received_")
      IF (DUMP_TOTAL_RAD_RECEIVED    .AND. CONVERT_TO_GEOTIFF) CALL MERGE_RASTERS(SEVEN, FN_TOTAL_RAD_RECEIVED_TIF , FN_TOTAL_RAD_RECEIVED_HDR , "total_rad_received_")
      IF (DUMP_HRR_TRANSIENT         .AND. CONVERT_TO_GEOTIFF) CALL MERGE_RASTERS(SEVEN, FN_HRR_TRANSIENT_TIF      , FN_HRR_TRANSIENT_HDR      , "hrr_transient_     ")
...
ELSE
      ...
      IF (DUMP_TOTAL_DFC_RECEIVED    .AND. CONVERT_TO_GEOTIFF) CALL MERGE_RASTERS(SEVEN, FN_TOTAL_DFC_RECEIVED_BIL , FN_TOTAL_DFC_RECEIVED_HDR , "total_dfc_received_")
      IF (DUMP_TOTAL_RAD_RECEIVED    .AND. CONVERT_TO_GEOTIFF) CALL MERGE_RASTERS(SEVEN, FN_TOTAL_RAD_RECEIVED_BIL , FN_TOTAL_RAD_RECEIVED_HDR , "total_rad_received_")
      IF (DUMP_HRR_TRANSIENT         .AND. CONVERT_TO_GEOTIFF) CALL MERGE_RASTERS(SEVEN, FN_HRR_TRANSIENT_BIL      , FN_HRR_TRANSIENT_HDR      , "hrr_transient_     ")
      IF (.NOT. ACCUMULATE_EMBER_FLUX) THEN
