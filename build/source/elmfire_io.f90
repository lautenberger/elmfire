      ...
      CASE('FLOAT')
         ...
         DO IBAND = 1, RASTER%NBANDS
            ...
            DO IROW_BIG = IROW_BIG_LO, IROW_BIG_HI
               RASTER%R4(ICOL_BIG_LO:ICOL_BIG_HI,IROW_BIG,MIN(IBAND,WS%NBANDS)) = RTEMP(:,IROW_SMALL)
...
TYPE(RASTER_TYPE) :: INTERMEDIATE_R4!, INTERMEDIATE_I2
TYPE(RASTER_TYPE), POINTER :: R
...
IF (DUMP_EMBER_FLUX .AND. ACCUMULATE_EMBER_FLUX) THEN 
   ...
   CALL ALLOCATE_EMPTY_RASTER(INTERMEDIATE_R4, R%NCOLS, R%NROWS, EMBER_FLUX%NBANDS, R%XLLCORNER, R%YLLCORNER, R%CELLSIZE, 0., 'FLOAT     ')

   CALL MPI_REDUCE(EMBER_FLUX%R4(:,:,:), INTERMEDIATE_R4%R4(:,:,:), ANALYSIS_NCOLS*ANALYSIS_NROWS*EMBER_FLUX%NBANDS, &
