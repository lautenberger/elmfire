...
! PARSE MAP_INFO INTO INDIVIDUAL COMPONENTS
IF (TRIM(MAP_INFO) /= '') THEN
   READ(MAP_INFO, *, IOSTAT=I) PROJECTION_NAME, X_PIXEL_REFERENCE, Y_PIXEL_REFERENCE, EASTING, NORTHING, X_PIXEL_SIZE, Y_PIXEL_SIZE
END IF
