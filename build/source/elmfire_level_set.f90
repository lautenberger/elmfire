...
IF (.NOT. RANDOM_IGNITIONS) THEN
   ...
   CALL SURFACE_SPREAD_RATE(LIST_BURNED,DUMMY_NODE)
   ...
   IF (CROWN_FIRE_MODEL .GT. 0) CALL CROWN_SPREAD_RATE(LIST_TAGGED,DUMMY_NODE)
   DO ISTEP=1,2
         ...
         DO IY = 1,NY
            DO IX = 1,NX
               ...
               IF (USE_EMBER_IGNITION_MODEL) THEN
                  ...
                  IF (.NOT. EMBER_IGNITION(IX,IY,T, WS20, 0.999)) CYCLE
               ELSE
