...
! Point pointers to analysis rasters:
   ...
   IF (NUM_TIME_AT_BURNED_ACRES .GT. 0) THEN
      ALLOCATE(ALREADY_REACHED_BURNED_ACRES(1:NUM_TIME_AT_BURNED_ACRES))
   ENDIF
...
IF (PROCESS_TIMED_LOCATIONS) THEN
   FN = TRIM(OUTPUTS_DIRECTORY) // 'timed-locations-events_' // FOUR_IRANK_WORLD
