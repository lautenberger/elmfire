...
INTEGER :: I, ILOC, J, IX, IY, ITIMESTEP, IX_IGN, IY_IGN, ISTEP, K, LU, IT1, IT2, &
           ...
           N_TO_TAG, N_SPOT_FIRES, ILH, IT2_LSP, IFBFM, IBLDGFM
...
REAL :: T_LAST_EXTENDED_ATTACK, T_LAST_INTERPOLATE_M1, T_LAST_INTERPOLATE_M10, T_LAST_INTERPOLATE_M100, &
        ...
        T_LAST_SMOKE_OUTPUT, QDOTNOW, XCEN, YCEN, THI, TLO, MDOTNOW, RADIUS, WN_FUEL, RUNTIME, T_TOTAL, P_IGNITION
...
IF (.NOT. RANDOM_IGNITIONS) THEN
   ...
   DO IX = 1, NX
      IF (PHIP(IX,IY) .LE. 0.) THEN
         ...
         ICOUNT = ICOUNT + 1
         CALL APPEND(LIST_BURNED, IX, IY, .FALSE., T)
         ...
         IF (USE_SDI) LIST_BURNED%TAIL%SDI = SDI_FACTOR * SDI%R4(IX,IY,1)
         ...
         DO IY = 1,NY
            DO IX = 1,NX
               ...
               IF (USE_EMBER_IGNITION_MODEL) THEN
                  ...
                  IF (.NOT. EMBER_IGNITION(IX,IY,T, DT, WS20, P_IGNITION, LOCAL_IGNITION_TIME, CELL_IGNITION_DELAY)) CYCLE
               ELSE
