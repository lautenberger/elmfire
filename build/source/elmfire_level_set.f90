...
REAL :: T_LAST_EXTENDED_ATTACK, T_LAST_INTERPOLATE_M1, T_LAST_INTERPOLATE_M10, T_LAST_INTERPOLATE_M100, &
        ...
        HARDENING_FACTCOR_LOCAL, HRRPUA_CRIT_LOCAL, HRRPUA_PEAK_LOCAL, T_EARLY_LOCAL, T_DECAY_LOCAL, T_FULLDEV_LOCAL
         ...
         DO I = 1, LIST_EMBER_DEPOSITED%NUM_NODES-1
            ...
            IF(PHIP(IX,IY) .GE. 0 .AND. SURFACE_FIRE(IX,IY) .LE. 0) THEN
               IF (USE_EMBER_IGNITION_MODEL) THEN
                  ...
                  IF (.NOT. EMBER_IGNITION(IX,IY,T, DT, WS20, P_IGNITION, LOCAL_IGNITION_TIME, CELL_IGNITION_DELAY, HARDENING_FACTCOR_LOCAL)) THEN
                     C => C%NEXT
                     CYCLE
                  ENDIF
               ELSE
