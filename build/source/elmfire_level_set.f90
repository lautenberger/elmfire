            ...
            IF (SURFACE_FIRE(IX,IY) .LE. 0 .AND. ADJ%R4(IX,IY,1) .GT. 0. .AND. (.NOT. ISNONBURNABLE(IX,IY) ) ) THEN
               ...
               IF (DUMP_SPOTTING_OUTPUTS) THEN
                  ...
                  IF (.NOT. LOPEN) THEN
                     ...
                     WRITE(712,'(A)') 'IX_FROM, IY_FROM, IX_TO, IY_TO, TLAUNCH, TIGN, DIST'
                  ENDIF

                  WRITE(712,998) SPOTTING_STATS(I)%IX_FROM, SPOTTING_STATS(I)%IY_FROM, IX, IY, SPOTTING_STATS(I)%TLAUNCH, SPOTTING_STATS(I)%TIGN, SPOTTING_STATS(I)%DIST
               ENDIF
...
998 FORMAT(I9.1,',',I9.1,',',I9.1,',',I9.1,',',F12.2,',',F12.2,',',F12.2)
...
IF (DUMP_SPOTTING_OUTPUTS) THEN
   ...
   ENDIF
   DO I = 1, NUM_TRACKED_EMBERS
      WRITE(712,998) SPOTTING_STATS(I)%IX_FROM, SPOTTING_STATS(I)%IY_FROM, SPOTTING_STATS(I)%IX_TO, SPOTTING_STATS(I)%IY_TO, SPOTTING_STATS(I)%TLAUNCH, SPOTTING_STATS(I)%TIGN, SPOTTING_STATS(I)%DIST
   ENDDO
ENDIF  
