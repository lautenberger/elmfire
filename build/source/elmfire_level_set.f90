...
INTEGER :: I, ILOC, J, IX, IY, ITIMESTEP, IX_IGN, IY_IGN, ISTEP, K, LU, IT1, IT2, &
           ...
           N_TO_TAG, N_SPOT_FIRES, ILH, IT2_LSP, ICOL, IROW
            ...
            IF (C%T_START_SPOTTING .LT. 1E-3) THEN
               IF (C%IFBFM .EQ. 91 ) THEN
                  IF (C%HRR_TRANSIENT .GE. CRITICAL_SPOTTING_FIRELINE_INTENSITY(FBFM%I2(C%IX,C%IY,1))/ANALYSIS_CELLSIZE ) THEN
                     ! Lines deactivated since the process is considered in the ignition function
         ...
         DO IY = 1,NY
            DO IX = 1,NX
               ...
               IF (USE_EMBER_IGNITION_MODEL) THEN
                  ...
                  IF (.NOT. EMBER_IGNITION(IX,IY,T, DT, WS20, PIGN, LOCAL_IGNITION_TIME, CELL_IGNITION_DELAY)) CYCLE
               ELSE
