...
REAL :: PHIMAG, PHIWX, PHIWY, PHIX, PHIY, WSMFEFF, A, B, COSANG, SINANG, BOH, DXDT, DYDT, DENOM, &
        ...
        RPHIMAG, RDENOM, SQRT_LOW2_M1, W!, STRUCTURE_AREA
INTEGER :: IASP, I, ILH, NITER, IWD20
...
! Determine individual slope and wind components and velocity in direction of maximum spread (DMS):
         ...
         DO WHILE (.NOT. DONE)
            ...
            IF (USE_BLDG_SPREAD_MODEL .AND. C%IFBFM .EQ. 91) THEN
               ...
               C%PHISY = 0.0
            ENDIF
            IWD20 = MIN( MAX( NINT(10.0 * C%WD20_NOW), 0 ), 3600 )   ! Round WD20 angle to nearest 0.1 degree

            PHIWX = APHIW * SINWDMPI(IWD20) !SIN( (C%WD20_NOW - 180.) * PIO180)
            PHIX  = C%PHISX + PHIWX

            PHIWY = APHIW * COSWDMPI(IWD20) !COS( (C%WD20_NOW - 180.) * PIO180)
            PHIY  = C%PHISY + PHIWY
...
! Calc CFL Variables
REAL :: CFL, COND, UMAX, DELTAUP, DELTALOC, PHIEAST=1.0, PHIWEST=1.0, PHINORTH=1.0, PHISOUTH=1.0
