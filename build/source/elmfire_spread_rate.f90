...
DO I = 1, SIZE(INDEX_FILTERED)
   ...
   ! Radiation
      ...
      ! IF (C%IX .EQ. 16 .AND. C%IY .EQ. 40) THEN
      !    WRITE(*,*) 'General:', T, LB_P%IX, LB_P%IY, MAX_ELLIPSE_DIST, ELLIPSE_DIST_THETA, TARGET_R_METERS, HRR_ADJUSTER, LB_P%HRR_TRANSIENT
      !    WRITE(*,*) 'DFC', DFC_HEAT_RECEIVED, DFC_FACTOR, DFC_COEFF
      !    WRITE(*,*) 'RAD', RAD_HEAT_RECEIVED, RAD_COEFF, RAD_FACTOR, LB_P%HRR_TRANSIENT, RAD_EFF_DIST
      ! ENDIF
ENDDO
