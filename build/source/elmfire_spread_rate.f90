...
REAL :: TARGET_R, TARGET_R_METERS, TARGET_THETA, WIND_THETA, TARGET_THETA_F, MAX_ELLIPSE_DIST, ELLIPSE_DIST_THETA, DFC_CHECKER, DFC_FACTOR, DFC_HEAT_RECEIVED, RAD_LIMIT_THETA, RAD_CHECKER, &
        ...
        DFC_COEFF, RAD_COEFF, FTP_PA, LHRR_PEAK
...
!      C%SIGN_Y = 1
   ...
   IF (LB_P%IFBFM .NE. 91) LHRR_PEAK = LB_P%FLIN_SURFACE/ANALYSIS_CELLSIZE
...
!! Radiation
   ...
   RAD_HEAT_RECEIVED = (0.35*DFC_COEFF*RAD_COEFF*RAD_FACTOR*LB_P%HRR_TRANSIENT*ANALYSIS_CELLSIZE**2)/(4*PI*RAD_EFF_DIST**2)
...
EARLY_TIME = BUILDING_FUEL_MODEL_TABLE(C%IBLDGFM)%T_EARLY
DEVELOPED_TIME = BUILDING_FUEL_MODEL_TABLE(C%IBLDGFM)%T_FULLDEV
DECAY_TIME = BUILDING_FUEL_MODEL_TABLE(C%IBLDGFM)%T_DECAY
