...
REAL :: TARGET_R, TARGET_R_METERS, TARGET_THETA, WIND_THETA, TARGET_THETA_F, MAX_ELLIPSE_DIST, ELLIPSE_DIST_THETA, &
        ...
        DFC_HEAT_FLUX, RAD_HEAT_FLUX, DFC_SIGMOID, RAD_SIGMOID, HRR_ADJUSTER

CALL ACCUMULATE_CPU_USAGE(70, IT1, IT2)
...
CALL ACCUMULATE_CPU_USAGE(71, IT1, IT2)
!**********************************
! Main Loop START
!**********************************
DO I = 1, LB%NUM_NODES
...
!   ENDIF 
   ...
   ! Direct Flame Contact
      ...
      DFC_HEAT_RECEIVED = DFC_COEFF*DFC_FACTOR*LB_P%HRR_TRANSIENT*HRR_ADJUSTER
   ...
   ! Radiation
      ...
      RAD_HEAT_RECEIVED = HRR_ADJUSTER*(0.3*DFC_COEFF*RAD_COEFF*RAD_FACTOR*LB_P%HRR_TRANSIENT*ANALYSIS_CELLSIZE_SQUARED)/(4*PI*RAD_EFF_DIST*RAD_EFF_DIST)
...
! Main Loop END
!**********************************
CALL ACCUMULATE_CPU_USAGE(72, IT1, IT2)
...
C%HEAT_VALUE = 0.
CALL ACCUMULATE_CPU_USAGE(73, IT1, IT2)
! *****************************************************************************
