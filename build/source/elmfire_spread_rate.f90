...
INTEGER :: I, TEMP_SX, TEMP_SY, DEL_X, DEL_Y
REAL, INTENT(IN) :: T
REAL :: TARGET_R, TARGET_R_METERS, TARGET_THETA, WIND_THETA, TARGET_THETA_F, MAX_ELLIPSE_DIST, ELLIPSE_DIST_THETA, &
        ...
        RDEL_X, RDEL_Y, ELLIPSE_MINOR_SQUARED, TOTAL_DFC, TOTAL_RADIATION
...
! Why is ANALYSIS_CELLSIZE raised to the 0 power here? 
   MAX_ELLIPSE_DIST = (ANALYSIS_CELLSIZE**0.0) * LB_P%ELLIPSE_PARAMETERS%DIST_DOWNWIND * (LB_P%ELLIPSE_PARAMETERS%ELLIPSE_MAJOR - LB_P%ELLIPSE_PARAMETERS%ELLIPSE_ECCENTRICITY) / ELLIPSE_MINOR_SQUARED
...
! Radiation
   ...
   RAD_HEAT_RECEIVED = (0.35*DFC_COEFF*RAD_COEFF*RAD_FACTOR*LB_P%HRR_TRANSIENT*ANALYSIS_CELLSIZE_SQUARED)/(4*PI*RAD_EFF_DIST*RAD_EFF_DIST)
