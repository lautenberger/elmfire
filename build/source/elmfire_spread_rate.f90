...
REAL :: TARGET_R, TARGET_R_METERS, TARGET_THETA, WIND_THETA, TARGET_THETA_F, MAX_ELLIPSE_DIST, ELLIPSE_DIST_THETA, DFC_CHECKER, DFC_FACTOR, DFC_HEAT_RECEIVED, RAD_LIMIT_THETA, RAD_CHECKER, &
        DELTA_RAD, RAD_FACTOR, RAD_EFF_DIST, RAD_HEAT_RECEIVED, TEMP_S, DEL_X, DEL_Y, V_S, SUM_ELLIPSE, FLAME_FRONT, FLAME_SIDE, FLAME_BACK, UCB_DIV
...
C%VELOCITY_DMS = C%ABSOLUTE_U*FLAME_FRONT/(SUM_ELLIPSE) ! Unit Transform to ft/min
